...
<div :style="{width: spineWidth * 10 + 'px'}" class="mid" ><div :class="{absoulte_center: true}" v-if="spineWidth > 7" class="mid_text"  v-html='spineTitle'></div><div :class="{absoulte_center: true}" class="mid_spine_width"  v-html='spineWidth'></div><div class="mid_blood_0" ></div><div class="mid_blood_1" ></div><div class="mid_blood_2" ></div><div class="mid_blood_3" ></div></div>
...
.fd_blood_0{
    width: 10px;
    height: 2px;background: #000;left: 0;top: 30px;position: absolute;
    z-index: 10;}
.fd_blood_1{
    width: 10px;
    height: 2px;background: #000;left: 0;bottom: 30px;position: absolute;
    z-index: 10;}
.fd_blood_2{
    width: 2px;
    height: 10px;background: #000;left: 30px;top: 0px;position: absolute;
    z-index: 10;}
.fd_blood_3{
    width: 2px;
    height: 10px;background: #000;left: 30px;bottom: 0px;position: absolute;
    z-index: 10;}
.mid{
    width: auto;
    height: 2100px;
...
.mid_spine_width{
    ...
    font-family: ;
    font-size: 10px;
    line-height: 10px;color: #333;
    z-index: 10;
    text-align: center;
  }
.mid_blood_0{
    width: 2px;
    height: 10px;background: #000;left: 0;top: 0px;position: absolute;
    z-index: 10;}
.mid_blood_1{
    width: 2px;
    height: 10px;background: #000;right: 0;top: 0px;position: absolute;
    z-index: 10;}
.mid_blood_2{
    width: 2px;
    height: 10px;background: #000;left: 0;bottom: 0px;position: absolute;
    z-index: 10;}
.mid_blood_3{
    width: 2px;
    height: 10px;background: #000;right: 0;bottom: 0px;position: absolute;
    z-index: 10;}
.fm{
    width: 1480px;
    height: 2100px;
...
.fm_blood_0{
    width: 2px;
    height: 10px;background: #000;right: 30px;top: 0;position: absolute;
    z-index: 10;}
.fm_blood_1{
    width: 2px;
    height: 10px;background: #000;right: 30px;bottom: 0;position: absolute;
    z-index: 10;}
.fm_blood_2{
    width: 10px;
    height: 2px;background: #000;right: 0;top: 30px;position: absolute;
    z-index: 10;}
.fm_blood_3{
    width: 10px;
    height: 2px;background: #000;right: 0;bottom: 30px;position: absolute;
    z-index: 10;}
