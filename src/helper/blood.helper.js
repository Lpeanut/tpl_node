...
const softBlood = {
  fm: [
    {wh: [2, 10], style: { right: '30px', top: '0' }},
    {wh: [2, 10], style: { right: '30px', bottom: '0' }},
    {wh: [10, 2], style: { right: '0', top: '30px' }},
    {wh: [10, 2], style: { right: '0', bottom: '30px' }}
  ],
  fd: [
    {wh: [10, 2], style: { left: '0', top: '30px' }},
    {wh: [10, 2], style: { left: '0', bottom: '30px' }},
    {wh: [2, 10], style: { left: '30px', top: '0px' }},
    {wh: [2, 10], style: { left: '30px', bottom: '0px' }}
  ],
  mid: [
    {wh: [2, 10], style: { left: '0', top: '0px' }},
    {wh: [2, 10], style: { right: '0', top: '0px' }},
    {wh: [2, 10], style: { left: '0', bottom: '0px' }},
    {wh: [2, 10], style: { right: '0', bottom: '0px' }}
  ]
}
